...
# Database Paths
default_stock_db = os.path.join(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "stocks.db"
)
default_backtest_db = os.path.join(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "backtest_results.db"
)
